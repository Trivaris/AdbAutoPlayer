...
class TestTemplateMatching(unittest.TestCase):
    def test_compare_roi_similarity(self):
        ...
        f5 = Path(__file__).parent / "data" / "records_formation_5.png"
        f6 = Path(__file__).parent / "data" / "records_formation_6.png"
        f7 = Path(__file__).parent / "data" / "records_formation_7.png"
